...
## Vision Basic v2.0.0
With help from Dennis Osborn, creator of Vision Basic, I have ported the code to Vision Basic (https://visionbasic.net/). This version is avialable on the disk image in logos2023v200.zip available for download above. LOAD"*",8 for the binary executable file. 
