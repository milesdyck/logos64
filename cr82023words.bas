1 rem - cre82022words, a basic program to create a relative file containing
2 rem - 366 words for logos64; written by Miles Dyck, November 2022
7900 rem - prior to running the program, the 2022words.rel file can be
7901 rem - created using live basic with the following commands:
7902 rem - open15,8,15
7903 rem - open2,8,2,"2022words,l,"+chrs$(6)
7904 rem - print#15,"p"+chr$(96+2)+chr$(110)+chr$(1)+chr$(1)
7905 rem - print#2,"emote";
7906 rem - close2
7907 rem - close15
